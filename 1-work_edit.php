...
<div class="card bg-light text-dark">
    ...
    <form action="1-work_save.php" method="post" enctype="multipart/form-data">
        ...
        <input type="submit" class="btn btn-secondary" value="บันทึกข้อมูล" >
        <input type="reset" class="btn btn-warning" value="พิมพ์ใหม่" >
        <a href="1-work.php" class="btn btn-primary">ย้อนกลับ</a>    
