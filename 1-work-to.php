            ...
            while($data=mysqli_fetch_row($result)) //ถ่ายโอนข้อมูลลงอาย์เรย์
                {
                    ...
                    echo "<td>";
                    echo $data[7]; //แสดงข้อมูลในคอลัมน์ที่ 3 แสดงไฟล์
                    echo "</td>";
                    ...
                    echo "<td><a class='btn btn-primary btn-success' href='return_filess/$data[7]' target='_blank'>เปิด</td>";
                    echo "<td><a class='btn btn-primary btn-warning' href='1-work_edit-too.php?id1=$data[0]' >ส่งกลับ</td>"; //ลิงค์สำหรับการแก้ไขข้อมูล
